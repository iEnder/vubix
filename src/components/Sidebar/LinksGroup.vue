...
<div class='links-group' >
    ...
    <ul class='links-group__list'>
        <li v-for="item in links" class='links-group__item'>
            <div @click="toggleSub(item.name.toLowerCase())" v-if="item.rest">
                <div class='links-group__container'>
                    <div class='links-group__container--category'>
                        ...
                        <span>
                            ...
                            <span :id="'drop-'+item.name.toLowerCase()" class="links-group__item--dropdown"><i class="fa fa-chevron-down" aria-hidden="true"></i></span>
                        </span>
                        
                    </div>
                </div>
                <LinksGroup :id="'sub-'+item.name.toLowerCase()" class="subgroup" :links="item.rest" />
            </div>
